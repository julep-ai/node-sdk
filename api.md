...
- <code><a href="./src/resources/shared.ts">Agent</a></code>
- <code><a href="./src/resources/shared.ts">ChatInput</a></code>
- <code><a href="./src/resources/shared.ts">ChatSettings</a></code>
- <code><a href="./src/resources/shared.ts">Doc</a></code>
...
- <code><a href="./src/resources/shared.ts">Execution</a></code>
- <code><a href="./src/resources/shared.ts">History</a></code>
- <code><a href="./src/resources/shared.ts">JobStatus</a></code>
- <code><a href="./src/resources/shared.ts">Message</a></code>
- <code><a href="./src/resources/shared.ts">Relation</a></code>
...
- <code><a href="./src/resources/shared.ts">Snippet</a></code>
- <code><a href="./src/resources/shared.ts">Task</a></code>
- <code><a href="./src/resources/shared.ts">Tool</a></code>
- <code><a href="./src/resources/shared.ts">Transition</a></code>
...
- <code title="get /agents/{agent_id}/tools">client.agents.tools.<a href="./src/resources/agents/tools.ts">list</a>(agentId, { ...params }) -> ToolsOffsetPagination</code>
...
- <code title="post /agents/{agent_id}/tasks/{task_id}">client.agents.tasks.<a href="./src/resources/agents/tasks.ts">createOrUpdate</a>(agentId, taskId, { ...params }) -> ResourceUpdated</code>
...
- <code title="patch /tasks/{task_id}/executions/{execution_id}">client.tasks.executions.<a href="./src/resources/tasks/executions.ts">update</a>(taskId, executionId, { ...params }) -> ResourceUpdated</code>
