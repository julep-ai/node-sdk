...
[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40julep%2Fsdk-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkBqdWxlcC9zZGstbWNwIl0sImVudiI6eyJKVUxFUF9BUElfS0VZIjoiU2V0IHlvdXIgSlVMRVBfQVBJX0tFWSBoZXJlLiJ9fQ)
...
```
claude mcp add julep_sdk_mcp_api --env JULEP_API_KEY="Your JULEP_API_KEY here." -- npx -y @julep/sdk-mcp
```
