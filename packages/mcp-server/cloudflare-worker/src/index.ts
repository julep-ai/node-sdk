...
import { McpOptions } from '@julep/sdk-mcp/options';
import { initMcpServer, newMcpServer } from '@julep/sdk-mcp/server';
import { configureLogger } from '@julep/sdk-mcp/logger';
  ...
  clientProperties: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'dev', value: 'dev' },
        { label: 'local_multi_tenant', value: 'local_multi_tenant' },
...
function fallbackMcpServer(): McpServer {
  return new McpServer(
    { name: 'julep_sdk_api', version: '2.7.4' },
