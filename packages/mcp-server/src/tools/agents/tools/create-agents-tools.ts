...
export const metadata: Metadata = {
  ...
  operationId: 'create_agent_tool_agents__agent_id__tools_post',
};

export const tool: Tool = {
  name: 'create_agents_tools',
...
export const handler = async (client: Julep, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.agents.tools.create(agent_id, body));
  } catch (error) {
