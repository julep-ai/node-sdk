...
export const metadata: Metadata = {
  ...
  operationId: 'create_or_update_task_agents__agent_id__tasks__task_id__post',
};
...
export const tool: Tool = {
  ...
  inputSchema: {
                    ...
                    arguments: {
                      anyOf: [
                        ...
                        },
                        {
                          ...
                          required: ['range', 'spreadsheet_id', 'values'],
                        },
                        {
                          type: 'object',
                        ...
                        },
                        {
                          ...
                          required: ['ranges', 'spreadsheet_id'],
                        },
                        {
                          type: 'object',
    ...
    required: ['agent_id', 'task_id', 'main', 'name'],
    $defs: {
      evaluate_step: {
        type: 'object',
        title: 'EvaluateStep',
...
export const handler = async (client: Julep, args: Record<string, unknown> | undefined) => {
  const { agent_id, task_id, ...body } = args as any;
  try {
    return asTextContentResult(await client.tasks.createOrUpdate(agent_id, task_id, body));
  } catch (error) {
