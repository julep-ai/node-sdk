...
export const handler = async (client: Julep, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.users.docs.bulkDelete(user_id, body)));
};
