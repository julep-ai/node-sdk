...
export namespace Task {
  export interface IfElseWorkflowStepOutput {
    ...
    then:
      ...
      | IfElseWorkflowStepOutput.ThenOutput;
     ...
     */
      ...
      | TasksAPI.ForeachStepOutput
      | TasksAPI.ParallelStepOutput
      | IfElseWorkflowStepOutput.ElseOutput
      | null;
...
export namespace TaskCreateParams {
  ...
  export interface IfElseWorkflowStepInput {
    ...
    then:
      ...
      | TasksAPI.ErrorWorkflowStep
      | unknown
      | IfElseWorkflowStepInput.SwitchStepInput
      | IfElseWorkflowStepInput.ForeachStepInput
      | IfElseWorkflowStepInput.ParallelStepInput
      | IfElseWorkflowStepInput.ThenInput;
     ...
     */
      ...
      | IfElseWorkflowStepInput.ForeachStepInput
      | IfElseWorkflowStepInput.ParallelStepInput
      | IfElseWorkflowStepInput.ElseInput
      | null;
