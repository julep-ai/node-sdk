...
describe('instantiate client', () => {
  ...
  test('normalized method', async () => {
    ...
    const client = new Julep({ baseURL: 'http://localhost:5000/', apiKey: 'My API Key', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Julep({ baseURL: 'http://localhost:5000/custom/path/', apiKey: 'My API Key' });
    ...
    afterEach(() => {
      process.env['JULEP_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Julep({ baseURL: 'https://example.com', apiKey: 'My API Key' });
    ...
    test('in request options overridden by client options', () => {
      const client = new Julep({ apiKey: 'My API Key', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
    ...
    test('in request options overridden by env variable', () => {
      process.env['JULEP_BASE_URL'] = 'http://localhost:5000/env';
      const client = new Julep({ apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['JULEP_API_KEY'] = 'My API Key';
    const client = new Julep();
  ...
  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['JULEP_API_KEY'] = 'another My API Key';
    const client = new Julep({ apiKey: 'My API Key' });
    expect(client.apiKey).toBe('My API Key');
  });
});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Julep({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Julep({ apiKey: 'My API Key', fetch: testFetch });
